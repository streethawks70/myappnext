...
const Home = () => {
  ...
  const sheetUrls: Record<string, string> = {
    ...
    'Distretto 5': 'https://script.google.com/macros/s/AKfycbxh9fvMeWgacTdWKCWEPINRYHJTBZuUyl2DyaxbK88qV1Gyh9-Siz7xsWBvPEv-pbD_/exec',
    'Distretto 6': 'https://script.google.com/macros/s/AKfycbxoLI6gw-qZ2KRMJhZKOFB2eTy-61BZ6X5S7NyJBO1GyWOWRZJH62jhI-jYopZ7Azhw/exec',
    ...
    'Distretto 13': 'https://script.google.com/macros/s/AKfycbwyhThR6krdipl7sE8RYmwAB5LBkYYm4bLOLqpHbeizFSIfp3V4ty8U-oFA2Ajb8Hew_Q/exec',
