...
> = {
  ...
  distretto4:
    process.env.GOOGLE_SHEET_ID_4,

  distretto5:
    process.env.GOOGLE_SHEET_ID_5,

  distretto6:
    process.env.GOOGLE_SHEET_ID_6,

  distretto8:
    process.env.GOOGLE_SHEET_ID_8,

  distretto9:
    process.env.GOOGLE_SHEET_ID_9,

  distretto10:
    process.env.GOOGLE_SHEET_ID_10,
